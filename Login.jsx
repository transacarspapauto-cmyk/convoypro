  ...
  return (
    <div style={{ display: "inline-flex", alignItems: "baseline", gap: base * 0.06 }}>
      ...
      <span style={{
        ...
        width: base * 0.22, height: base * 0.22,
        background: C.accent,
        borderRadius: base * 0.04,
        marginBottom: base * 0.05,
        flexShrink: 0,
      }} />
    </div>
  );
...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    // Succès : onAuthStateChange dans useAuth() met à jour la session automatiquement
  }
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-card       { animation: fadeUp .28s ease both; }
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                width: "100%",
                background: disabled ? C.accentMist : C.accent,
                border: `1px solid ${disabled ? C.accentBorder : C.accent}`,
                borderRadius: 8,
                padding: "12px 0",
                fontSize: 15,
                fontFamily: fb,
                fontWeight: 700,
                color: disabled ? C.accentLight : "#fff",
